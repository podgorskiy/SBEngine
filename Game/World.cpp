...
void World::CreateNeomine()
{
	...
	Door* door = new Door(2, -1, 61, -1, -1);
	door->AddDestination([]
	{
		return Oquonie::GetInstance()->m_player->m_id == "nastazie";
	}, 154, -1, -1);
